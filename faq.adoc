...
summary: "Find answers to common NDM questions about connection errors, authentication failures, protocol issues, and permission errors."
---
...
.What can cause this error Wrong credentials - NT_STATUS_LOGON_FAILURE?
...
.What can cause the 'Invalid export path' error?

Ensure that the export path is correctly entered and exists on the server.

.What can cause the 'Invalid working directory' error?
...
.What is the difference between 'Stop' and 'Deactivate'?

Stop terminates an ongoing job run. Deactivate makes a job unavailable until you reactivate it.
