...
.What's next?
After learning about NetApp Data Migrator, you can link:decide-to-use-data-migrator.html[decide whether to use the software for your data migration operations].