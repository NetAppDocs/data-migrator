...
.Before you begin
For AWS and Azure, you need to request access to the AWS or Azure images. Send an email from your company email to ng-ndm-downloads@netapp.com requesting access to the AWS or Azure images with the following information:

* Attach a screenshot of your NetApp Support Site My Profile page, which shows your access level including your company email ID. 
* Indicate whether you want to deploy in Azure or AWS. 
* For AWS, include your AWS account information and the region where the Amazon Machine Images (AMIs) will be deployed. 

You will receive an email from ng-ndm-downloads@netapp.com with the NetApp Data Migrator details. 

[NOTE]
====
For Azure, the pre-signed URL is only valid for two days. 

For AWS, the AMIs are shared with the AWS account that you provided in the original email. 
====

If you are using Google Cloud or OVA, download the image from the link:https://mysupport.netapp.com/site/downloads[NetApp Support Site^] and proceed with deployment. 
