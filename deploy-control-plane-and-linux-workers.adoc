...
.Before you begin
For AWS and Azure, request access to the AWS or Azure images. You need to provide the following information when requesting access:
...
You will receive an email with the NetApp Data Migrator details. For AWs, copy the AMIs into your AWS account. This process gives you full ownership, avoids dependency on the source account, and is required for cross-region use.
