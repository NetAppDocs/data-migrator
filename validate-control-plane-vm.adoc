...
.What's next? 
After validating the control plane and worker deployment, you can link:networking-requirements.html[configure access for control plane and worker nodes].
