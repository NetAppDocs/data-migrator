...
summary: 
---
= Upgrade control plane and workers in NDM
:icons: font
:imagesdir: ./media/

[.lead]
You can upgrade a control plane, Linux worker, or Windows worker in NetApp Data Migrator (NDM). 
...
. If a worker upgrade doesn't start automatically, use SSH to connect to the worker and start the upgrade manually:
+
[role="tabbed-block"]
====
.Linux worker
