...
.What's next?
After learning about installing NetApp Data Migrator, you can perform one of the following tasks:

* link:register-for-account.html[Register for an account] on the NetApp Support Site if you are a new customer
* link:deploy-control-plane-and-linux-workers.html[Deploy the control plane and Linux worker VMs] if you already have an account