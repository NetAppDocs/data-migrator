...
[.lead]
You need to install a control plane and workers to run NFS and SMB migration jobs using NetApp Data Migrator. 
...
After deployment, you create the control plane and worker VMs to access NetApp Data Migrator. You create the control plane VM and Linux worker VM using the deployed images. You create the Windows worker VM using the Windows Worker Installer, which you download from the NetApp Support site.
